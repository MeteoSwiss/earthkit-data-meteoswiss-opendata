...
Thank you for your interest in contributing to **earthkit-data-meteoswiss-opendata**! We welcome contributions from the community and are grateful for your support.
...
- Python 3.11 or higher (up to 3.11)
...
1. Clone your fork of the repository:
   ...
   ```console
   $ git clone https://github.com/YOUR-USERNAME/earthkit-data-meteoswiss-opendata.git
...
```console
$ poetry run pytest --cov=earthkit_data_meteoswiss_opendata --cov-report=html
```
...
Thank you for contributing to earthkit-data-meteoswiss-opendata!